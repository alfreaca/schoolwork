...
class Machine:
    ...
    def menu(self):
        choice = input("What would you like to do? [a] insert more money, [b] play the game, [c] view the previous goes and money files or [d] exit: ")
        while choice != "a" and choice != "b" and choice != "c" and choice != "d":
            choice = input("Please choose either [a] insert more money, [b] play the game, view the previous goes and "
                           "money files[c] or exit[d]: ")
